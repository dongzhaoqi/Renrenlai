...
import com.siti.renrenlai.activity.RegisterActivity;
                ...
                public void onAddressPicked(String province, String city, String county) {
                    if (county==null){
                        ...
                        if(province.equals(city)){
                            address.append(province).append(" ").append(county);
                        }else{
                            address.append(province).append(" ").append(city).append(" ").append(county);
                        }
                        delegate.processFinish(String.valueOf(address));
